...
export class ProfessionService {
  ...
  async createProfession(createProfessionDto: CreateProfessionDto): Promise<CreateProfessionDto> {
    ...
    if(!newProfession || createProfessionDto===null) throw new BadRequestException("Something went wrong in create Profession...");
  ...
  async updateProfession(id: string, updateProfessionDto: UpdateProfessionDto): Promise<number> {
