...
export class ProfessionController {
  ...
  @Get("profession")
  @GetDecoratorByTitle()
  async getProfessionByTitle(@Query("prof_title") profTitle: string): Promise<ProfessionEntity[] | []> {
    try {
  ...
  @Post()
  @CreateDecorator()
  async createProfession(@Body() createProfessionDto: CreateProfessionDto): Promise<CreateProfessionDto> {
    try {
  ...
  @Put(":id")
  @UpdateDecoratorByID()
  async updateProfession(@Param("id") id: string, @Body() updateProfessionDto: UpdateProfessionDto): Promise<number> {
    try {
