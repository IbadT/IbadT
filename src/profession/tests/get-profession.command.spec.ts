...
describe("GetProfesstionCommand", () => {
  ...
  beforeEach(async () => {
    ...
    getProfesssionQuery = moduleRef.get<GetProfessionsQuery>(GetProfessionsQuery);
      ...
      const professions = [
        {
          ...
          image_src: "https://media.geeksforgeeks.org/wp-content/uploads/20190506164011/logo3.png",
